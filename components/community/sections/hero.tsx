...
export function HeroSection() {
  ...
  return (
    <section className="flex flex-col items-center justify-center md:items:start w-full min-h-[369px] px-4 md:px-8 lg:px-16 py-12 md:py-28 gap-10 md:gap-20 mx-auto relative md:min-h-[500px]">
      ...
      {/* Content */}
      <div className="relative flex flex-col z-10 items-center max-w-3xl w-full px-4 md:px-0">
        <h1 className="text-4xl text-center sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gradient mb-4 md:mb-6">
          Join Our Community
        </h1>
        <p className="text-lg sm:text-lg text-center md:text-xl text-[var(--foreground)] mb-6 md:mb-8">
