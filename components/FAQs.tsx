...
const FAQs = () => {
  ...
  const floatingElementPositions = [
    { left: 5, top: 20, size: 3 },
    { left: 80, top: 15, size: 5 },
    { left: 90, top: 60, size: 4 },
    { left: 20, top: 85, size: 6 },
    { left: 70, top: 30, size: 3 },
    { left: 15, top: 55, size: 4 },
    { left: 85, top: 75, size: 5 }
  ];
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(135deg, var(--card-bg) 0%, var(--background) 50%, var(--card-bg) 100%)"
      }}
    >
          ...
          {floatingElementPositions.map((pos, i) => (
            <div
              ...
              style={{
                ...
                width: `${pos.size}rem`,
                height: `${pos.size}rem`,
                background: `radial-gradient(circle at center, var(--accent)/15 0%, var(--primary)/5 100%)`,
                filter: 'blur(10px)',
                opacity: 0.4
              }}
            />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Call to Action */}
        <div ref={ctaRef} className="text-center mt-12" style={{ opacity: 1, visibility: 'visible' }}>
          <div className="max-w-2xl mx-auto p-8 bg-[var(--card-bg)] rounded-2xl border border-[var(--border)] shadow-lg">
            <h4 className="text-xl font-bold mb-4 text-[var(--foreground)]">Still have questions?</h4>
            <p className="text-[var(--muted)] mb-6">Reach out to our support team for assistance.</p>
            <button className="px-8 py-3 bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] text-[var(--foreground)] font-medium rounded-lg shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300">
              Contact Us
            </button>
          </div>
        </div>
