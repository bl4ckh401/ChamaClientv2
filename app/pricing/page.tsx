          ...
          <div className="text-center">
            ...
            <div className="pricing-toggle flex justify-center mb-12">
              <div className="inline-flex p-1 bg-[var(--muted)] rounded-lg border border-[var(--border)]">
                ...
                >
                  Yearly
                  <span className="absolute -top-2 -right-2 bg-[var(--accent)] text-[var(--background)] text-xs px-1.5 py-0.5 rounded-full">
                    20% off
                  </span>
                </button>
              </div>
              ...
              >
                ...
                {plan.badge && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                    <span className="bg-[var(--primary)] text-[var(--background)] px-4 py-1 text-sm font-medium rounded-full">
                      {plan.badge}
                    </span>
                  </div>
                )}
              ...
              <div className="min-w-full">
                ...
                <div className="p-6 bg-[var(--card-bg)] rounded-b-2xl border border-[var(--border)] border-t-0">
                  <div className="grid grid-cols-4 gap-4">
                    <div></div>
                    <div className="text-center">
                      <button className="w-full py-2 px-4 border border-[var(--primary)] text-[var(--primary)] rounded-lg hover:bg-[var(--primary)] hover:text-[var(--background)] transition-colors duration-200">
                        Get Started
                      </button>
                    </div>
                    <div className="text-center">
                      <button className="w-full py-2 px-4 bg-[var(--primary)] text-[var(--background)] rounded-lg hover:bg-[var(--primary)]/90 transition-colors duration-200">
                        Start Trial
                      </button>
                    </div>
                    <div className="text-center">
